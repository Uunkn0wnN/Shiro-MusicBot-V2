module.exports = {
  ...
  Presence: {
    ...
    name: "https://github.com/Uunkn0wnN ", // The message shown
  ...
  Lavalink: {
    ...
    host: "181.214.231.105", //- The host name or IP of the lavalink server.
    port: 6665, // The port that lavalink is listening to. This must be a number!
    pass: "syslink", //- The password of the lavalink server.
